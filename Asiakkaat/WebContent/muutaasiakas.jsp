...
<form id="tiedot">
	...
	<input type="hidden" name="asiakas_id" id="asiakas_id" value="">
</form>
<span id="ilmo"></span>
</body>
<script>
$(document).ready(function(){
	...
	// Haetaan muutettavan asiakkaan tiedot. GET /asiakkaat/haeyksi/asiakas_id
...
//funktio, jolla päivitetään tiedot PUT-metodilla, mukana välitetään tiedot json-stringinä
//PUT /asiakkaat
